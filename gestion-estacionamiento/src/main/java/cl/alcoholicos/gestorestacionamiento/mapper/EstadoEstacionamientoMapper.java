...
public interface EstadoEstacionamientoMapper {
    ...
    EstadoEstacionamientoEntity toEntity(EstadoEstacionamientoCreateDTO estadoEstacionamientoCreateDTO);

    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    void updateFromUpdateDTO(EstadoEstacionamientoResponseDTO updateDTO,
            @MappingTarget EstadoEstacionamientoEntity entity);
}
