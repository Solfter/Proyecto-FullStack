...
public class EstadoEstacionamientoController {
    ...
    @Operation(
        summary = "Obtener todos los estados de estacionamiento",
        description = "Retorna una lista con todos los estados disponibles para los espacios de estacionamiento " +
    ...
    @ApiResponses(value = {
        @ApiResponse(
            responseCode = "200",
            description = "Lista de estados de estacionamiento obtenida exitosamente",
            content = @Content(
        ...
        @ApiResponse(
            responseCode = "204",
            description = "No se encontraron estados de estacionamiento configurados en el sistema",
            content = @Content
        ),
        @ApiResponse(
            responseCode = "500",
            description = "Error interno del servidor al obtener los estados",
            content = @Content
        )
    })
    @GetMapping
